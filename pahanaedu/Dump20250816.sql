...
--
-- Host: 127.0.0.1    Database: pahana_billing
-- ------------------------------------------------------
...
CREATE TABLE `bills` (
  ...
  CONSTRAINT `bills_ibfk_1` FOREIGN KEY (`customer_account_number`) REFERENCES `customers` (`account_number`)
...
-- Dump completed on 2025-08-16 12:38:55
